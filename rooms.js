...
export const CORRIDORS = [
  ...
  { id: "C_MH_POWER", x: 6, z: -6, w: 4, d: 2, color: 0x1c2036 },
  { id: "C_MH_MAP", x: -10, z: -6, w: 4, d: 2, color: 0x1c2036 },
  { id: "C_MH_LOUNGE", x: 6, z: 2, w: 4, d: 2, color: 0x1c2036 },
  { id: "C_MH_STORAGE", x: -10, z: 2, w: 4, d: 2, color: 0x1c2036 },
  // Main Hall <-> Rest Area (center column, going "down" the map)
  { id: "C_MH_REST", x: -3, z: 4, w: 4, d: 8, color: 0x1c2036 },
  // Right column: Power Room -> Lounge -> First-Aid
  { id: "C_POWER_LOUNGE", x: 12, z: -4, w: 4, d: 6, color: 0x1c2036 },
  { id: "C_LOUNGE_FIRSTAID", x: 12, z: 9, w: 4, d: 3, color: 0x1c2036 },
  // Left column: Map Room -> Storage -> Control Room
  { id: "C_MAP_STORAGE", x: -16, z: -4, w: 4, d: 6, color: 0x1c2036 },
  { id: "C_STORAGE_CONTROL", x: -16, z: 9, w: 4, d: 3, color: 0x1c2036 },
  // Bottom row loop: Rest Area <-> First-Aid / Control Room
  { id: "C_REST_FIRSTAID", x: 4, z: 14, w: 6, d: 2, color: 0x1c2036 },
  { id: "C_REST_CONTROL", x: -10, z: 14, w: 6, d: 2, color: 0x1c2036 },
];
