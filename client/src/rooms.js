...
// stand. Used by the client to block walking through walls. The margin
// MUST match the server's (server/src/constants.js isWalkable call site,
// currently 0.3) — if the client is stricter than the server, players feel
// a false "stuck" stutter right at narrow doorway thresholds, where the
// client's local prediction rejects a move the server would have allowed.
