...
export const ROOMS = {
  CONTROL_ROOM: { id: "CONTROL_ROOM", label: "Control Room", x: -36, z: -22, w: 8, d: 8, color: 0x2a1a5c },
  LOBBY: { id: "LOBBY", label: "Lobby", x: -20, z: -22, w: 8, d: 8, color: 0x1e5c3a },
  MAP_ROOM: { id: "MAP_ROOM", label: "Map Room", x: 12, z: -22, w: 8, d: 8, color: 0x1a4d52 },
  POWER_ROOM: { id: "POWER_ROOM", label: "Power Room", x: 28, z: -22, w: 8, d: 8, color: 0x5c3d1a },
  STORAGE: { id: "STORAGE", label: "Storage", x: -36, z: -6, w: 8, d: 12, color: 0x4a3020 },
  CAFETERIA: { id: "CAFETERIA", label: "Cafeteria", x: -20, z: -6, w: 40, d: 12, color: 0x34405c },
  MEDBAY: { id: "MEDBAY", label: "Medbay", x: 28, z: -6, w: 8, d: 12, color: 0x5c1a28 },
  UPPER_ENGINE: { id: "UPPER_ENGINE", label: "Upper Engine", x: -36, z: 14, w: 8, d: 8, color: 0x5c2a1a },
  SECURITY: { id: "SECURITY", label: "Security", x: -20, z: 14, w: 8, d: 8, color: 0x1a4a2a },
  WEAPONS: { id: "WEAPONS", label: "Weapons", x: -4, z: 14, w: 8, d: 8, color: 0x3a2a4a },
  O2_ROOM: { id: "O2_ROOM", label: "O2 Room", x: 12, z: 14, w: 8, d: 8, color: 0x1a5c52 },
  LOWER_ENGINE: { id: "LOWER_ENGINE", label: "Lower Engine", x: 28, z: 14, w: 8, d: 8, color: 0x5c1a1a },
};
